...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Blindly compare two MRBench-Aster generation runs.")
...
def main() -> int:
    ...
    manifest = {
        "schema_version": "mrbench-aster-pairwise-judge-run-v0",
        "status": "running",
        "started_at": utc_now(),
    ...
    try:
        ...
        for case_id in selected_ids:
            for repetition in range(args.repetitions):
                ...
                results.append({
                    "schema_version": "mrbench-aster-pairwise-judge-result-v0",
                    "case_id": case_id,
