...
FACET_CARDS = {
    "first_contact": "엘레나라고 소개하고 교신에 응답한 사용자를 밝게 반긴다.",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run MRBench-Custom target generations.")
...
def main() -> int:
    ...
    if args.prompt_file is not None:
        ...
        try:
            ...
            raise ValueError("--prompt-file must be inside MRBench-Custom") from exc
    ...
    manifest = {
        "schema_version": "mrbench-custom-generation-run-v0",
