...
def render_markdown(rows: list[dict[str, Any]]) -> str:
    lines = [
        "# MRBench-Custom AutoJudge Summary",
        "",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Aggregate MRBench-Custom raw judge scores.")
...
def main() -> int:
    ...
    summary = {
        "schema_version": "mrbench-custom-summary-v0",
