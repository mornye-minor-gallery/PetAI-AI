...
public struct ConversationConfig {
  ...
  /// Maximum number of tokens generated by this session. `nil` uses the
  /// model or engine default without changing the KV-cache input budget.
  ...
  ///   - maxOutputTokens: Maximum decoded tokens for this session. Must be
